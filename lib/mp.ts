...
export async function createPreference(
  ...
  return {
    ...
    init_point:
      "https://www.mercadopago.com.ar/checkout/v1/redirect?pref_id=mock-preference-id",
    sandbox_init_point:
      "https://sandbox.mercadopago.com.ar/checkout/v1/redirect?pref_id=mock-preference-id",
  };
}
...
export function validateMercadoPagoConfig(): boolean {
  const requiredVars = ["NEXT_PUBLIC_MP_PUBLIC_KEY", "MP_ACCESS_TOKEN"];
